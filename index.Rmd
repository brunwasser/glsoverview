...
* Harrell F. (2020). [Regression Modeling Strategies](http://hbiostat.org/doc/rms1.pdf)
...
* The mean trajectory of the outcome variable is simulated to be nonlinear, as is common in longitudinal research. This will allow us to demonstrate the utility of restricted cubic splines to capture nonlinear mean trajectories (see [Harrell 2020](http://hbiostat.org/doc/rms1.pdf) section 2.4.5).
```{r}
